...
/**
 * @author Paul X-47
 * taken from http://stackoverflow.com/a/20979488/7069565
 * 
 * This class is implemented due to limitations of java.awt.Robot class to handle keypress events
 * for certain characters, such as colons, backslashes and underscores.   
 * 
 *
 */
...
/**
 * Constructs a new KeyboardKeys object.
 * @throws AWTException
 */
...
/**
 * Constructs a new KeyboardKeys object by reusing a Robot object.
 * @param robot Engine used to send keystrokes into screen.
 * 
 */
...
/**
 * Sends a single stroke into the primary screen.
 * @param characterKey character to input.
 */
...
/**
 * Sends a keystroke from the numeric pad.
 */
...
/**
 * creates a keystroke by simulating presing the Alt + numeric code.
 * @param numpadCodes numeric code of letter to press.
 */
